    ...
    <table  class="table table-bordered responsive-table">
        ...
        <?php foreach ($a_permission_modules as $module_id => $a_modules) { ?>
            <tr>
                ...
                <td><div align="center"><?php echo form_checkbox('read[' . $module_id . ']', '1', ($a_modules['read'] ? TRUE : FALSE)); ?></div></td>
            ...
            <tr>
                <td><span class="btn btn-metis-<?php echo $count_sub_mod;?> btn-xs btn-circle btn-grad"><?php echo $count_sub_mod;?></span></td>
